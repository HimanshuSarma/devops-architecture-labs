...
#   name   = "k8s-master-node-asg-template"
...
#   # 🟢 Automatically replaces running instances whenever the template changes
#   instance_refresh {
#     strategy = "Rolling"
#     preferences {
