...
resource "aws_route" "vpc_a_private_to_other_vpcs" {
  # This creates a route for every private route table the module generated
  depends_on = [aws_ec2_transit_gateway.transit_gateway_vpc_a_b_c, aws_ec2_transit_gateway_vpc_attachment.vpc_a_attachment]
...
resource "aws_route" "vpc_a_public_to_other_vpcs" {
